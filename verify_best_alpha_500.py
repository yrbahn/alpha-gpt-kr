...
def main():
    ...
    if results:
        ...
        for _, row in df.iterrows():
            ...
            degradation = (train_ic - ic) / train_ic * 100
            
            print(f"\n{name}")
            print(f"  학습 IC (100종목): {train_ic:.4f}")
            print(f"  검증 IC (500종목): {ic:.4f}")
